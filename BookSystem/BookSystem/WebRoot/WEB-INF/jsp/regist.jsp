...
<script type="text/javascript">
	function change() {
		document.getElementById("im").src = "${pageContext.request.contextPath}/users/checkcode?time"
				+ new Date().getTime();
	};
	...
	function checkNull(field){
		...
		if (reg.test(value)) {
			document.getElementById(field+"_span").innerHTML=("不能为空");
			return false;
		}
...
<body>
	<form action="${pageContext.request.contextPath }/users/regist" method="post" onsubmit="return checkForm();">
		...
		<table border="1" align="center" width="65%">
			...
			<tr>
				<td>验证码</td>
				<td><input type="text" name="checkcode" id="checkcode"><img src='${pageContext.request.contextPath}/users/checkcode' id="im" onclick="change();"><span id="checkcode_span"><a
